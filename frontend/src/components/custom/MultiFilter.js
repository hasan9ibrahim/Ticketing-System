...
export const FILTER_FIELDS = [
  ...
  { id: "enterprise", label: "Customer", type: "search" },
  { id: "enterprise_trunk", label: "Customer Trunk", type: "select" },
  ...
  { id: "enterprise_name", label: "Customer Name", type: "text", placeholder: "Enter customer name..." },
